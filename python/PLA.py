...
# Huấn luyện mô hình SGDClassifier với regularization
# penalty='l2' cho L2 regularization, 'l1' cho L1, hoặc 'elasticnet' cho ElasticNet
model = SGDClassifier(loss='perceptron', penalty='l2', max_iter=1000, eta0=0.1, random_state=42)
...
if len(set(y)) == 2:
    # Dự đoán xác suất
    y_test_proba = model.decision_function(X_test)  # Thay vì predict_proba với SGDClassifier

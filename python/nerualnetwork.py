...
# Tham số
learning_rate = 0.1  # Thay đổi learning rate
epochs = 40000  # Giảm số lượng epochs để thử nghiệm

# Tham số cho regularization
lambda_reg = 0.0001  # Tham số điều chỉnh cho regularization
...
joblib.dump(model, "C:/Users/Nam's computer/Desktop/python/neuralnetwork.pkl")
